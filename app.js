...
function anteprimaPreventivo() {
    ...
    const htmlAnteprima = `
        ...
        <body>
            <div class="header">
                <img src="assets/img/logo-dettofatto.png" alt="DettoFatto" />
            ...
            <div class="footer">
                ...
                <div class="stamp">
                    <img src="assets/img/timbro-dettofatto.png" alt="Timbro" />
                </div>
            </div>
        </body>
        </html>
    ...
    try {
        ...
        pdfContainer.innerHTML = `
            <div style="margin-bottom: 30px; text-align: center;">
                <img src="assets/img/logo-dettofatto.png" style="max-width: 400px; height: auto; margin-bottom: 15px;" />
            ...
            <div style="margin-top: 50px; margin-bottom: 40px; display: flex; justify-content: space-between; align-items: flex-start;">
                ...
                <div style="text-align: right; margin-top: 20px;">
                    <img src="assets/img/timbro-dettofatto.png" style="max-width: 180px; height: auto;" />
                </div>
            </div>
        `;
